...
<ProfileCard 
  name="Alfie"
  description={'Alfie, the orange snuggler known for his penchant for goofiness, proudly holds the title of the middle cat. His approach to life encapsulates a perfect blend of playful antics and serene cuddle sessions. With a spirit that radiates warmth, Alfie finds joy in the simple pleasures of life, embodying the quintessential balance between energy and calm.'}
